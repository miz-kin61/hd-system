...
CENTER_ISSUES = {
    "Head": {
        "curse": "【社会の呪い】「常に明確なビジョンを持て」「自分で考えろ」\n └ 他人の疑問を自分のタスクとして抱え込み、脳がオーバーヒート。",
        "truth": "【本来の仕様】処理しなくていいインスピレーションはスルーできる『高感度アンテナ』。",
        "solution": "「その疑問、私の管轄外（システム外）です」"
    },
    "Ajna": {
        "curse": "【社会の呪い】「一貫性を持て」「ブレるな」\n └ 一度言ったことに固執し、無理やり固定の正解を出そうとして苦しむ。",
        "truth": "【本来の仕様】新しい概念を次々インストールできる『クラウド型柔軟思考モジュール』。",
        "solution": "「昨日の私と今日の私は、別バージョン（アップデート済）です」"
    },
    "Throat": {
        "curse": "【社会の呪い】「自分から発信しろ」「沈黙は気まずい」\n └ 沈黙を恐れて場を繋ぐために無駄な発言をし、空回りする。",
        "truth": "【本来の仕様】外部トリガーで起動した時に、最大の出力を持つ『オンデマンド型スピーカー』。",
        "solution": "「呼ばれるまで、システムはスタンバイ状態（沈黙）で大正解」"
    },
    "G": {
        "curse": "【社会の呪い】「自分探しをしろ」「確固たるキャラを持て」\n └ 常に「本当の自分」を探し求めて迷子になる。",
        "truth": "【本来の仕様】環境や接続先によって、最適なパスに自動ルーティングされる『カメレオン型ナビ』。",
        "solution": "「私のキャラと居場所は、環境依存で変わってOK」"
    },
    "Heart": {
        "curse": "【社会の呪い】「約束は死んでも守れ」「努力して価値を証明しろ」\n └ 限界を超えて安請け合いし、心臓が焼き切れるまで稼働してしまう。",
        "truth": "【本来の仕様】証明競争から完全に降りていい『無重力モジュール』。",
        "solution": "「私には証明すべき価値などない。無理な約束は強制キャンセル」"
    },
    "Sacral": {
        "curse": "【社会の呪い】「途中で投げ出すな」「周りが働いているのに休むな」\n └ 休むタイミングを見失って過労ダウンする。",
        "truth": "【本来の仕様】必要量だけエネルギーを借りて、用が済んだらパッと手放せる『非蓄電バッテリー』。",
        "solution": "「今日使い切るエネルギーは元々ない。疲れる前に電源オフ」"
    },
    "Splenic": {
        "curse": "【社会の呪い】「石の上にも三年」「手放すのはもったいない」\n └ 『今手放すと危険だ』という恐怖に支配され、有害な環境に依存する。",
        "truth": "【本来の仕様】違和感を検知したら、過去に縛られず即座に切り離せる『セキュリティ検知器』。",
        "solution": "「違和感のあるシステム（環境・人）は、即アンインストール」"
    },
    "SolarPlexus": {
        "curse": "【社会の呪い】「空気を読め」「感情的になるな」\n └ 衝突を極端に恐れ、自分のエラーを握りつぶして『いい人』を偽装する。",
        "truth": "【本来の仕様】他者の感情をサンプリングし、フラットに観察できる『共感レシーバー』。",
        "solution": "「この波風（感情）は他人のもの。私はただ波に乗るだけ」"
    },
    "Root": {
        "curse": "【社会の呪い】「早く終わらせろ」「タスクを溜めるな」\n └ タスクキューを無理やり空にしようと常に焦燥感に追われる。",
        "truth": "【本来の仕様】プレッシャーをスルーし、マイペースに処理できる『外部圧力フリーの独立エンジン』。",
        "solution": "「急いでもタスクは一生減らない。他人の焦りは華麗にスルー」"
    }
}
