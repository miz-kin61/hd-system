...
DEFINED_CENTER_ISSUES = {
    "Head": {
        ...
        "solution": "「私のシステムに他人のデータを混ぜない。興味のないことは完全シャットアウト」"
    },
    "Ajna": {
    ...
    "G": {
        ...
        "solution": "「私は動かない。私というサーバーに合うクライアント（人）だけがアクセスすればいい」"
    },
    "Heart": {
        ...
        "solution": "「安売りはシステム劣化の元。自分の価値を認め、堂々と対価（お金や評価）を要求する」"
    },
    "Sacral": {
        ...
        "solution": "「頭で考えて動かない。肚（システム深部）が反応するまで、ただ待機（リスン）する」"
    },
    "Splenic": {
        ...
        "solution": "「理由は分からないけど、なんか嫌だからそうする。エビデンス（証拠ログ）は不要」"
    },
    "SolarPlexus": {
        ...
        "solution": "「素晴らしい提案ですね。一旦キャッシュに保存して、数日寝かせてからお返事します」"
    },
    "Root": {
        ...
        "solution": "「私はプレッシャーがある方が燃える。ギリギリのバッチ処理こそ私の最適稼働」"
    }
}

# 【追加】プロファイル別 IT特性・役割（理系女子向け）
